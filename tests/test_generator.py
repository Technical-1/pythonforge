"""
Tests for quickforge.generator
===========================
...
class TestTemplateRendering:
    ...
    def test_render_all_templates_library(self, basic_config: ProjectConfig) -> None:
...
class TestFileWriting:
    ...
    def test_write_files(self, basic_config: ProjectConfig) -> None:
        ...
        assert (
            basic_config.project_dir / "subdir/nested.txt"
...
class TestGitInitialization:
    ...
    def test_init_git_handles_missing_git(self, basic_config: ProjectConfig) -> None:
        """Test graceful handling when git is not installed."""
        create_directory_structure(basic_config)

        # Mock subprocess to simulate git not found
        with patch("quickforge.generator.subprocess.run") as mock_run:
...
class TestProjectValidation:
    ...
    def test_validate_invalid_python_syntax(self, basic_config: ProjectConfig) -> None:
...
class TestCreateProject:
    ...
    def test_create_project_fails_if_exists(self, basic_config: ProjectConfig) -> None:
    ...
    def test_create_project_result_files(self, basic_config: ProjectConfig) -> None:
